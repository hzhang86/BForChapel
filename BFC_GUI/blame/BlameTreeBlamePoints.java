...
public class BlameTreeBlamePoints extends JPanel implements MouseListener {
    /**
	 * 
	 */
    ...
    public BlameTreeBlamePoints(BlameContainer bc) {
    ...
    private void createNodes(DefaultMutableTreeNode top) {
    	...
    	Iterator<BlameFunction> it = bc.getAllFunctions().values().iterator();
    	while (it.hasNext())
		{
