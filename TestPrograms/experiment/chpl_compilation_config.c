...
#include <stdio.h>
const char* chpl_compileCommand = "chpl -g -o ./experiment experiment.chpl --llvm --savec=./ ";
const char* chpl_compileVersion = "1.10.0.b3ab51b";
...
void chpl_program_about() {
  printf("%s", "Compilation command: chpl -g -o ./experiment experiment.chpl --llvm --savec=./ \n");
  printf("%s", "Chapel compiler version: 1.10.0.b3ab51b\n");
